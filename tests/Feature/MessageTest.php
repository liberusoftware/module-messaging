...
it('can create a message between users', function () {
    ...
    $recipient = TestUser::factory()->create();
...
it('has sender and recipient relationships', function () {
    $sender = TestUser::factory()->create(['name' => 'John Doe']);
    $recipient = TestUser::factory()->create(['name' => 'Jane Smith']);
